...
export default function Demo() {
  ...
  return (
    <>
      ...
      >
        <Button variant="outlined" onClick={() => themeService.toggleTheme()}>
          Theme wechseln
        </Button>
        <Button
          variant="outlined"
          onClick={() =>
            notificationService.showInfoMessage(
              "Eine Info kann hier ganz einfach angezeigt werden, aus allen react-client-Komponenten.",
            )
          }
        >
          Eine Info anzeigen
        ...
        <Button
          ...
          onClick={() =>
            notificationService.showErrorMessage(
              "Eine Fehlermeldung kann genauso angezeigt werden!",
            )
          }
        >
